...
<?php
    ...
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, "http://localhost:8080/TeacherManagement/rest/Teacher/TeacherManagement/GetListAnnouncement/");
                        ...
                        <div class="card">
                            ...
                            <div class="content">
                                <?php
                                    ...
                                    ?> 
                                        <div class="typo-line">
                                        <p class="category" style ="max-width:160px"><?= substr($a['datepost'], 0, 10);?></p>
